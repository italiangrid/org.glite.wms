/* soapDelegation1SoapBindingObject.h
...
#ifndef soapDelegation1SoapBindingObject_H
#define soapDelegation1SoapBindingObject_H
#include "soapH.h"
...
class Delegation1SoapBindingService : public soap
{    public:
