...
#ifndef _GLITE_WMS_MANAGER_NS_DAEMON_DAEMONEXCEPTIONS_H_
#define _GLITE_WMS_MANAGER_NS_DAEMON_DAEMONEXCEPTIONS_H_
...
namespace daemon {
  ...
  class CannotStartException : public daemon::Exception
  {
   public: 
    CannotStartException( const std::string& message ) :
      daemon::Exception( std::string(""), std::string(""), _CANNOT_START_ERR_, "CannotStartException" )
    {
