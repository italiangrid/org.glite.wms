...
*******************************************************************/
 int UserCredential::checkProxy (const string& cred_path) {
     EDG_STACK_TRY("checkProxy (const string& cred_path)")   ;
...
string UserCredential::getIssuer      (const string& cred_path){
     EDG_STACK_TRY("getIssuer      (const string& cred_path)")   ;
     string subj , issuer;
...
*******************************************************************/
 string UserCredential::getSubject     (const string& cred_path){
     EDG_STACK_TRY("getSubject     (const string& cred_path) ");
     string subj ;
     string issuer;
     int cred_type, strength, time_left;
     getInfo ( subj,  issuer,  cred_type,  strength,  time_left);
...
*******************************************************************/
 int UserCredential::getCredType    (const string& cred_path) {
     EDG_STACK_TRY("getCredType    (const string& cred_path)");
     string subj , issuer;
     int cred_type, strength, time_left;
     getInfo ( subj,  issuer,  cred_type,  strength,  time_left);
     return  cred_type;
...
*******************************************************************/
 int UserCredential::getStrenght    (const string& cred_path) {
     EDG_STACK_TRY("getStrenght    (const string& cred_path) ");
     string subj , issuer;
     int cred_type, strength, time_left;
     getInfo ( subj,  issuer,  cred_type,  strength,  time_left);
     return  strength;
...
*******************************************************************/
 int UserCredential::getTimeLeft (const string& cred_path) {
     EDG_STACK_TRY("getTimeLeft (const string& cred_path)");
     string subj , issuer;
     int cred_type, strength, time_left;
     getInfo ( subj,  issuer,  cred_type,  strength,  time_left);
     return  time_left;
...
void UserCredential::getInfo(string& subj, string& issuer, int& cred_type, int& strength, int& time_left, const string& cred_path ) {
   EDG_STACK_TRY("getInfo(string& subj, string& issuer, int& cred_type, int& strength, int& time_left, const string& cred_path ) ");
...
void UserCredential::destroy(const string& cred_path ) {
      EDG_STACK_TRY("destroy(const string& cred_path ) ");
      string proxy_path;
      char uid [128] ;
...
std::string  UserCredential::getDefaultVoName (){
	// vomsdata vo_data ("/opt/edg/etc/" , "/etc/grid-security/certificates/" ) ;
	vomsdata vo_data ;
	load_voms(  vo_data ) ;
	voms v;
	// get Default voms
