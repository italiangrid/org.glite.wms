...
# Description of the test: VOMS server installation using APT                        #
# Requisites: None                                                                   #
# Inputs: None                                                                       #
#                                                                                    #
#                                                                                    #  
...
# delete previous existing java rpms
rpm -e j2re-1.4.2_06-4.cern
...
apt-get -yf install --yes glite-VOMS_oracle

if [ $? ];
then
  echo 'TEST : VOMS server installation using APT, has succeeded'
else
  echo 'TEST : VOMS server installation using APT, has failed'
fi
