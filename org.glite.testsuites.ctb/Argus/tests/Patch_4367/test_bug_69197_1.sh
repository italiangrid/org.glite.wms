...
echo \"/dteam\" ${DTEAM} > ${target_file}
echo \"${xxx_tmp}\" ${DN_UID_GROUP} >> ${target_file}
echo ${target_file};cat ${target_file}

# Now sort out the pepd.ini file
# The EMI location is: /etc/argus/pepd/pepd.ini
# The gLite location: /opt/argus/pepd/conf/pepd.ini
# 
# pep_config="/opt/argus/pepd/conf/pepd.ini"
# pep_config_saved="/tmp/pepd.ini.saved"
...
preferDNForLoginName="preferDNForLoginName = true"
