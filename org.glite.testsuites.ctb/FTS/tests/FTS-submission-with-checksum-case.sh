...
do
  echo 
  echo "Submitting a file transfer job using $ALGO lowercase"
  file_transfer_with_checksum $SOURCE_SAPATH $DEST_SAPATH $ALGO --compare-checksum both --lowercase
  ...
  echo "$ALGO lowercase OK!"

  # Uppercase
  echo 
  echo "Submitting a file transfer job using $ALGO uppercase"
  file_transfer_with_checksum $SOURCE_SAPATH $DEST_SAPATH $ALGO --compare-checksum both --uppercase
