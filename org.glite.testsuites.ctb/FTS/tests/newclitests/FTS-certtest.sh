...
if [ "x${BASIC}" = "xyes" ]; then
  ...
  tests_list=("${tests_list[@]}" "cli-common-arguments.sh")
  tests_list=("${tests_list[@]}" "cli-transfer-cancel.sh")
  tests_list=("${tests_list[@]}" "cli-transfer-channel-add.sh")
  tests_list=("${tests_list[@]}" "cli-transfer-channel-audit.sh")
  tests_list=("${tests_list[@]}" "cli-transfer-channel-drop.sh")
  tests_list=("${tests_list[@]}" "cli-transfer-channel-list.sh")
