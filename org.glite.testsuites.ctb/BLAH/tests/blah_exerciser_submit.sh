...
# Start submission of the n jobs as defined in the 'blah_test.conf' file 
...
#
# For all the submitted jobs wait for result and get the status until they are all completed
#
