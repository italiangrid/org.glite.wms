...
%description
This package contains the following Nagios probes:
...
install --mode 755 .%dir/CREAMCE-probe  %{buildroot}%{dir}
install --mode 755 .%dir/CREAMCEDJS-probe  %{buildroot}%{dir}
install --mode 755 .%dir/CREAMDJS-jdl.template  %{buildroot}%{dir}
install --mode 755 .%dir/CREAM-jdl.template  %{buildroot}%{dir}
%{__cp} -rpf .%dir/wnjob  %{buildroot}%{dir}
install --directory %{buildroot}%{etcdir}
install --mode 644 .%{etcdir}/emi.nagios-jobmngt.conf %{buildroot}%{etcdir}
...
%defattr(-,root,root,-)
%{dir}/CREAMCE-probe
%{dir}/CREAMCEDJS-probe
%{dir}/CREAMDJS-jdl.template
%{dir}/CREAM-jdl.template
%{dir}/wnjob
%config(noreplace) %{etcdir}/emi.nagios-jobmngt.conf
%config(noreplace) %{dir}/wnjob/emi.wn/etc/wn.d/emi.wn/commands.cfg
%config(noreplace) %{dir}/wnjob/emi.wn/etc/wn.d/emi.wn/services.cfg
%{pylib}/*.py*
%doc README
%doc CHANGES
