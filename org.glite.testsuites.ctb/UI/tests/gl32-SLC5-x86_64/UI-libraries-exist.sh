...
LIBRARIES="$LCG_LOCATION/lib64/liblcg_util.so $LCG_LOCATION/lib64/liblcg_util.a"
LIBRARIES="$LIBRARIES $LCG_LOCATION/lib64/libgfal.so $LCG_LOCATION/lib64/libgfal.a"
LIBRARIES="$LIBRARIES $GLOBUS_LOCATION/lib/libglobus_gass_copy_gcc64.so $GLOBUS_LOCATION/lib/libglobus_gass_copy_gcc64.a"
