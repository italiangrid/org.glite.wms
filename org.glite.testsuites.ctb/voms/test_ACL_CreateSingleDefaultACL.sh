...
# Description of the test: Create 1 default ACL                                             #
#                                                                                           #
# Input Parameters:                                                                         #
#       - VO name                                                                           #
...
voms-admin --vo=$1 add-default-acl-entry $2 $3 $4 $5

if [ $? ]; 
then
  echo $? ' TEST : Create default ACL, has succeeded'
else
  echo $? ' TEST : Create default ACL, has failed'
fi
