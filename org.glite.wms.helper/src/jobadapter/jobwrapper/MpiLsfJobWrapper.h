...
#ifndef GLITE_WMS_HELPER_JOBADAPTER_JOBWRAPPER_MPI_LSF_JOB_WRAPPER_H
#define GLITE_WMS_HELPER_JOBADAPTER_JOBWRAPPER_MPI_LSF_JOB_WRAPPER_H
...
class MpiLsfJobWrapper : public JobWrapper
{
...
public:
   ...
   *  \ingroup jobadapter
   */
  MpiLsfJobWrapper(const std::string& job);
...
#endif // GLITE_WMS_HELPER_JOBADAPTER_JOBWRAPPER_MPI_LSF_JOB_WRAPPER_H
