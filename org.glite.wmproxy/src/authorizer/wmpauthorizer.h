...
public:
	...
	*/
	...
	static bool compareFQANAuthN(const std::string &infqan, const std::string &reffqan); 	
	...
	*/
	static void checkProxyExistence(const std::string &proxypath, const std::string &jobid);
