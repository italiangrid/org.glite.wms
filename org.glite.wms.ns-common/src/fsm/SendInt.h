#ifndef _GLITE_WMS_MANAGER_NS_FSM_SENDINT_H_
#define _GLITE_WMS_MANAGER_NS_FSM_SENDINT_H_
...
/**
 * This State sends an int attribute of the command over a connection. 
 * @author Marco Pappalardo marco.pappalardo@ct.infn.it
 * @author Salvatore Monforte salvatore.monforte@ct.infn.it
 */
class SendInt : public CommandState 
{
 public:
  /**
   * Constructor
