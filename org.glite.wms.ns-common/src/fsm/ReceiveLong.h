#ifndef _GLITE_WMS_MANAGER_NS_FSM_RECEIVELONG_H_
#define _GLITE_WMS_MANAGER_NS_FSM_RECEIVELONG_H_
 ...
 */
class ReceiveLong : public CommandState 
{
 public:
  /**
   * Constructor
   ...
   */
  ReceiveLong(const std::string& s);
