...
public class TestSer {
	...
	public TestSer() throws Exception {
		...
		// Copied from src/autogen/org/glite/wms/wmproxy/WMProxyStub.java
		// from method: "public WMProxyStub(javax.xml.rpc.Service service)"
           ...
           java.lang.Class cls;
            ...
            cachedSerQNames.add(qName);
            cls = org.ggf.schemas.bes._2006._08.bes_factory.ActivityDocumentType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://schemas.ggf.org/bes/2006/08/bes-factory", "BasicFactoryResourceAttributesDocumentType");
            cachedSerQNames.add(qName);
            cls = org.ggf.schemas.bes._2006._08.bes_factory.BasicFactoryResourceAttributesDocumentType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = org.ggf.schemas.bes._2006._08.bes_factory.CreateActivityResponseType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = org.ggf.schemas.bes._2006._08.bes_factory.CreateActivityType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = org.ggf.schemas.bes._2006._08.bes_factory.FactoryResourceAttributesDocumentType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = org.ggf.schemas.bes._2006._08.bes_factory.NotAcceptingNewActivitiesFaultType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = org.ggf.schemas.bes._2006._08.bes_factory.UnsupportedFeatureFaultType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://schemas.ggf.org/bes/2006/08/bes-factory", "UnsupportedJSDLVersionFaultType");
            cachedSerQNames.add(qName);
            cls = org.ggf.schemas.bes._2006._08.bes_factory.UnsupportedJSDLVersionFaultType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://www.gridsite.org/namespaces/delegation-2", ">DelegationException");
            cachedSerQNames.add(qName);
            cls = org.gridsite.www.namespaces.delegation_2.DelegationException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://www.gridsite.org/namespaces/delegation-2", ">NewProxyReq");
            cachedSerQNames.add(qName);
            cls = org.gridsite.www.namespaces.delegation_2.NewProxyReq.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = org.w3.www._2005._08.addressing.AttributedAnyType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
