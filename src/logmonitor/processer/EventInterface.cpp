...
const string      EventInterface::ei_s_edgideq( "EDG id = " ), EventInterface::ei_s_subnodeof( "Sub job of DAG: " );
const string      EventInterface::ei_s_notsub( "Job seems to be not submitted by EDG." );
...
const string      EventInterface::ei_s_errremcorr( "Error removing CondorId <-> EDGid correspondance." );
