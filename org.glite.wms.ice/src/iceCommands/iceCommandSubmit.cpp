...
void ice::iceCommandSubmit::execute( void ) throw( iceCommandFatal_ex&, iceCommandTransient_ex& )
{
    ...
    m_theJob.setUserDN( glite::ce::cream_client_api::certUtil::getDN(m_theJob.getUserProxyCertificate()) );
...
//   cout << "iceCommandSubmit::doSubscription - Calling subMgr->hasSubscription("
//        << userProxy << ", " 
//        << cemon_url << " )"
//        << endl;
