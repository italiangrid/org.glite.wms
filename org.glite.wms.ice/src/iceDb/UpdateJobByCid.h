...
#ifndef GLITE_WMS_ICE_ICEDB_UPDATEJOBBYCID_H
#define GLITE_WMS_ICE_ICEDB_UPDATEJOBBYCID_H
...
namespace db {
     ...
     */
    class UpdateJobByCid : public AbsDbOperation { 
    public:
        UpdateJobByCid( const std::string& gid,
