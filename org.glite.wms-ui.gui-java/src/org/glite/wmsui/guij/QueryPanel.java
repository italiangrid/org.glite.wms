...
public class QueryPanel extends JDialog {
  ...
  JCheckBox jCheckBoxSubmitted = new JCheckBox(JobStatus.code[JobStatus.
      SUBMITTED]);
  ...
  JCheckBox jCheckBoxScheduled = new JCheckBox(JobStatus.code[JobStatus.
      SCHEDULED]);
  ...
  JCheckBox jCheckBoxCancelled = new JCheckBox(JobStatus.code[JobStatus.
      CANCELLED]);
  ...
  private void jbInit() throws Exception {
    ...
    jTextFieldDay1.setText(Integer.toString(calendar.get(Calendar.DAY_OF_MONTH)));
    ...
    jTextFieldDay1.addFocusListener(new java.awt.event.FocusAdapter() {
      public void focusLost(FocusEvent e) {
        GraphicUtils.jTextFieldFocusLost(jTextFieldDay1, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.DAY_OF_MONTH)), 1, 31);
      }
    });
    ...
    jTextFieldMonth1.setText(Integer.toString(calendar.get(Calendar.MONTH) + 1));
    ...
    downYear1.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.downButtonEvent(jTextFieldYear1, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.YEAR)), 1970, 9999);
      }
    });
    downDay1.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.downButtonEvent(jTextFieldDay1, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.DAY_OF_MONTH)), 1, 31);
      }
    });
    upMonth1.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.upButtonEvent(jTextFieldMonth1, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.MONTH) + 1), 1, 12);
      }
    });
    upYear1.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.upButtonEvent(jTextFieldYear1, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.YEAR)), 1970, 9999);
      }
    });
    downMonth1.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.downButtonEvent(jTextFieldMonth1, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.MONTH) + 1), 1, 12);
      }
    });
    upDay1.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.upButtonEvent(jTextFieldDay1, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.DAY_OF_MONTH)), 1, 31);
      }
    });
    ...
    downHourFrom.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.downButtonEvent(jTextFieldHourFrom, Utils.INTEGER,
            Integer.toString(
            calendar.get(Calendar.HOUR_OF_DAY)), 0, 23);
      }
    });
    upMinuteFrom.setBounds(new Rectangle(454, 81, 16, 14));
    upMinuteFrom.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.upButtonEvent(jTextFieldMinuteFrom, Utils.INTEGER,
    ...
    downMinuteFrom.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.downButtonEvent(jTextFieldMinuteFrom, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.MINUTE)), 0, 59);
      }
    });
    ...
    upHourFrom.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.upButtonEvent(jTextFieldHourFrom, Utils.INTEGER, Integer.toString(
            calendar.get(Calendar.HOUR_OF_DAY)), 0, 23);
      }
    });
    ...
    downHourTo.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.downButtonEvent(jTextFieldHourTo, Utils.INTEGER, Integer.toString(
            calendar.get(Calendar.HOUR_OF_DAY)), 0, 23);
      }
    });
    ...
    upMinuteTo.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.upButtonEvent(jTextFieldMinuteTo, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.MINUTE)), 0, 59);
      }
    });
    ...
    downMinuteTo.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.downButtonEvent(jTextFieldMinuteTo, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.MINUTE)), 0, 59);
      }
    });
    ...
    upHourTo.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.upButtonEvent(jTextFieldHourTo, Utils.INTEGER, Integer.toString(
            calendar.get(Calendar.HOUR_OF_DAY)), 0, 23);
      }
    });
    ...
    jTextFieldHourTo.setText(Integer.toString(calendar.get(Calendar.HOUR_OF_DAY)));
    ...
    jTextFieldMinuteFrom.setText(Integer.toString(calendar.get(Calendar.MINUTE)));
    jTextFieldMinuteFrom.addFocusListener(new java.awt.event.FocusAdapter() {
      public void focusLost(FocusEvent e) {
        GraphicUtils.jTextFieldFocusLost(jTextFieldMinuteFrom, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.MINUTE)), 0, 59);
    ...
    jTextFieldHourFrom.setText(Integer.toString(calendar.get(Calendar.
        HOUR_OF_DAY)));
    jTextFieldHourFrom.addFocusListener(new java.awt.event.FocusAdapter() {
      public void focusLost(FocusEvent e) {
        GraphicUtils.jTextFieldFocusLost(jTextFieldHourFrom, Utils.INTEGER,
    ...
    downSecondFrom.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.downButtonEvent(jTextFieldSecondFrom, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.SECOND)), 0, 59);
      }
    });
    jTextFieldSecondFrom.setHorizontalAlignment(SwingConstants.RIGHT);
    jTextFieldSecondFrom.setText(Integer.toString(calendar.get(Calendar.SECOND)));
    ...
    upSecondFrom.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.upButtonEvent(jTextFieldSecondFrom, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.SECOND)), 0, 59);
      }
    });
    ...
    downSecondTo.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.downButtonEvent(jTextFieldSecondTo, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.SECOND)), 0, 59);
      }
    });
    ...
    upSecondTo.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.upButtonEvent(jTextFieldSecondTo, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.SECOND)), 0, 59);
      }
    });
  ...
  void jButtonOkEvent(ActionEvent ae) {
    ...
    if (!isEditing) {
      if (queryName.equals("")) {
        ...
        JOptionPane.showOptionDialog(QueryPanel.this,
            "Query Name is a mandatory field",
            Utils.ERROR_MSG_TXT,
            JOptionPane.DEFAULT_OPTION,
            JOptionPane.ERROR_MESSAGE,
            null, null, null);
      ...
      if (queryPreferencesPanel.jobTableModel.isElementPresentInColumnCi(
          queryName,
          queryPreferencesPanel.QUERY_NAME_COLUMN_INDEX)) {
        jTextFieldQueryName.grabFocus();
        JOptionPane.showOptionDialog(QueryPanel.this,
            "Query '" + queryName + "' is already defined",
            Utils.ERROR_MSG_TXT,
            JOptionPane.DEFAULT_OPTION,
            JOptionPane.ERROR_MESSAGE,
            null, null, null);
    ...
    if ((jTableTags.getRowCount() == 0) && !jCheckBoxFrom.isSelected()
      ...
      jComboBoxTagName.grabFocus();
      JOptionPane.showOptionDialog(QueryPanel.this,
          "Please provide at least a Tag "
          + "or a From/To Date-Time",
          Utils.ERROR_MSG_TXT,
          JOptionPane.DEFAULT_OPTION,
          JOptionPane.ERROR_MESSAGE,
          null, null, null);
    ...
    if (jCheckBoxFrom.isSelected()) {
      ...
      if (fromCalendar.getTimeInMillis() > calendar.getTimeInMillis()) {
        JOptionPane.showOptionDialog(QueryPanel.this,
            "From Date-Time follows current Date-Time",
    ...
    if (jCheckBoxTo.isSelected()) {
      ...
      if (jCheckBoxFrom.isSelected()
        ...
        JOptionPane.showOptionDialog(QueryPanel.this,
            "To Date-Time precedes From Date-Time",
            Utils.ERROR_MSG_TXT,
            JOptionPane.DEFAULT_OPTION,
            JOptionPane.ERROR_MESSAGE,
            null, null, null);
    ...
    for (int i = 0; i < jTableTags.getRowCount(); i++) {
      try {
        userTagsAd.setAttribute(jobTableModel.getValueAt(i,
            ...
            jobTableModel.getValueAt(i, TAG_VALUE_COLUMN_INDEX).toString());
      } catch (Exception e) {
        JOptionPane.showOptionDialog(QueryPanel.this,
            "Unable to Add query",
            Utils.ERROR_MSG_TXT,
    ...
    try {
      ...
      userQueryAd.setAttribute(Utils.OWNED_JOBS_ONLY_FLAG,
          jCheckBoxOwned.isSelected());
      if (jCheckBoxFrom.isSelected()) {
        userQueryAd.setAttribute(Utils.FROM_DATE,
            new Long(fromCalendar.getTimeInMillis()).toString());
      }
      if (jCheckBoxTo.isSelected()) {
        userQueryAd.setAttribute(Utils.TO_DATE,
            new Long(toCalendar.getTimeInMillis()).toString());
      }
      userQueryAd.setAttribute(Utils.USER_TAGS, userTagsAd);
      userQueryAd.setAttribute(Utils.INCLUDE_STATE_ARRAY, getIncludeStateString());
    } catch (Exception e) {
      JOptionPane.showOptionDialog(QueryPanel.this,
          "Unable to Add query",
          Utils.ERROR_MSG_TXT,
    ...
    if (isEditing) {
      queryPreferencesPanel.setQueryToTable(queryName, lbAddress,
          new Boolean(jCheckBoxOwned.isSelected()), userQueryAd);
    } else {
      queryPreferencesPanel.addQueryToTable(queryName, lbAddress,
          new Boolean(jCheckBoxOwned.isSelected()), userQueryAd);
    }
    ...
    if ((userQueryAd != null) && (userQueryAd.size() != 0)) {
      try {
        ...
        if (userQueryAd.hasAttribute(Utils.FROM_DATE)) {
          ...
          jTextFieldDay.setText(new Integer(fromCalendar.get(Calendar.
              DAY_OF_MONTH)).toString());
          jTextFieldMonth.setText(new Integer(fromCalendar.get(Calendar.MONTH)
              + 1).toString());
          jTextFieldYear.setText(new Integer(fromCalendar.get(Calendar.YEAR)).
              toString());

          jTextFieldHourFrom.setText(new Integer(fromCalendar.get(Calendar.
              HOUR_OF_DAY)).toString());
          jTextFieldMinuteFrom.setText(new Integer(fromCalendar.get(Calendar.
              MINUTE)).toString());
          jTextFieldSecondFrom.setText(new Integer(fromCalendar.get(Calendar.
              SECOND)).toString());
        ...
        if (userQueryAd.hasAttribute(Utils.TO_DATE)) {
          ...
          jTextFieldDay1.setText(new Integer(toCalendar.get(Calendar.
              DAY_OF_MONTH)).toString());
          jTextFieldMonth1.setText(new Integer(toCalendar.get(Calendar.MONTH)
              + 1).toString());
          jTextFieldYear1.setText(new Integer(toCalendar.get(Calendar.YEAR)).
              toString());

          jTextFieldHourTo.setText(new Integer(toCalendar.get(Calendar.
              HOUR_OF_DAY)).toString());
          jTextFieldMinuteTo.setText(new Integer(toCalendar.get(Calendar.MINUTE)).
              toString());
          jTextFieldSecondTo.setText(new Integer(toCalendar.get(Calendar.SECOND)).
              toString());
        ...
        if (userQueryAd.hasAttribute(Utils.INCLUDE_STATE_ARRAY)) {
          String stateString = userQueryAd.getStringValue(Utils.
              INCLUDE_STATE_ARRAY).get(0).toString();
