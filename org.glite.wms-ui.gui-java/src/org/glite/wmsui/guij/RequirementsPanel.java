...
public class RequirementsPanel extends JPanel {
  ...
  BasicArrowButton upMinMainMemory = new BasicArrowButton(BasicArrowButton.
      NORTH);
  BasicArrowButton downMinMainMemory = new BasicArrowButton(BasicArrowButton.
      SOUTH);
  BasicArrowButton upSpecFloat2000 = new BasicArrowButton(BasicArrowButton.
      NORTH);
  BasicArrowButton downSpecFloat2000 = new BasicArrowButton(BasicArrowButton.
      SOUTH);
  ...
  BasicArrowButton upTimeToTraverseQueue = new BasicArrowButton(
      BasicArrowButton.NORTH);
  BasicArrowButton downSpecInt2000 = new BasicArrowButton(BasicArrowButton.
      SOUTH);
  ...
  BasicArrowButton downMinSpaceOnSE = new BasicArrowButton(BasicArrowButton.
      SOUTH);
  ...
  private void jbInit() throws Exception {
    ...
    jTextFieldRuntimeEnvironment.addFocusListener(new java.awt.event.
        FocusAdapter() {
      public void focusLost(FocusEvent e) {
    ...
    downMinMainMemory.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.downButtonEvent(jTextFieldMinMainMemory, Utils.FLOAT,
            Float.toString(Utils.MIN_MAIN_MEMORY_DEF_VAL),
    ...
    upMinMainMemory.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.upButtonEvent(jTextFieldMinMainMemory, Utils.FLOAT,
            Float.toString(Utils.MIN_MAIN_MEMORY_DEF_VAL),
            Utils.MIN_MAIN_MEMORY_MIN_VAL, Utils.MIN_MAIN_MEMORY_MAX_VAL);
      }
    });
    downSpecFloat2000.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.downButtonEvent(jTextFieldSpecFloat2000, Utils.FLOAT,
    ...
    upSpecFloat2000.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.upButtonEvent(jTextFieldSpecFloat2000, Utils.FLOAT,
            Float.toString(Utils.SPEC_FLOAT_2000_DEF_VAL),
            Utils.SPEC_FLOAT_2000_MIN_VAL, Utils.SPEC_FLOAT_2000_MAX_VAL);
      }
    });
    jTextFieldMinMainMemory.setText(Float.toString(Utils.
        MIN_MAIN_MEMORY_DEF_VAL));
    jTextFieldMinMainMemory.setHorizontalAlignment(SwingConstants.RIGHT);
    jTextFieldMinMainMemory.addFocusListener(new java.awt.event.FocusListener() {
      public void focusLost(FocusEvent e) {
        GraphicUtils.jTextFieldFocusLost(jTextFieldMinMainMemory, Utils.FLOAT,
            Float.toString(Utils.MIN_MAIN_MEMORY_DEF_VAL),
            Utils.MIN_MAIN_MEMORY_MIN_VAL, Utils.MIN_MAIN_MEMORY_MAX_VAL);
      }
    ...
    jTextFieldSpecFloat2000.setText(Float.toString(Utils.
        SPEC_FLOAT_2000_DEF_VAL));
    ...
    downMinNumberOfFreeCPUs.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    upMinNumberOfFreeCPUs.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    jTextFieldMinNumberOfFreeCPUs.addFocusListener(new java.awt.event.
        FocusAdapter() {
      public void focusLost(FocusEvent e) {
    ...
    jTextFieldMinNumberOfFreeCPUs.setText(Integer.toString(Utils.
        MIN_NUMBER_OF_FREE_CPUS_DEF_VAL));
    jTextFieldMinNumberOfFreeCPUs.setHorizontalAlignment(SwingConstants.RIGHT);
    downMaxAvailableCPUTime.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    upMaxAvailableCPUTime.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    jTextFieldMaxAvailableCPUTime.addFocusListener(new java.awt.event.
        FocusAdapter() {
      public void focusLost(FocusEvent e) {
    ...
    jTextFieldMaxAvailableCPUTime.setText(Float.toString(Utils.
        MAX_AVAILABLE_CPU_TIME_DEF_VAL));
    jTextFieldMaxAvailableCPUTime.setHorizontalAlignment(SwingConstants.RIGHT);
    jTextFieldTimeToTraverseQueue.setText(Float.toString(Utils.
        TIME_TO_TRAVERSE_QUEUE_DEF_VAL));
    jTextFieldTimeToTraverseQueue.setHorizontalAlignment(SwingConstants.RIGHT);
    jTextFieldTimeToTraverseQueue.addFocusListener(new java.awt.event.
        FocusAdapter() {
      public void focusLost(FocusEvent e) {
    ...
    upSpecInt2000.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.upButtonEvent(jTextFieldSpecInt2000, Utils.INTEGER,
            Integer.toString(Utils.SPEC_INT_2000_DEF_VAL),
            Utils.SPEC_INT_2000_MIN_VAL, Utils.SPEC_INT_2000_MAX_VAL);
      }
    });
    downTimeToTraverseQueue.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    jTextFieldSpecInt2000.setText(Integer.toString(Utils.SPEC_INT_2000_DEF_VAL));
    ...
    upTimeToTraverseQueue.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    downSpecInt2000.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.downButtonEvent(jTextFieldSpecInt2000, Utils.INTEGER,
            Integer.toString(Utils.SPEC_INT_2000_DEF_VAL),
            Utils.SPEC_INT_2000_MIN_VAL, Utils.SPEC_INT_2000_MAX_VAL);
      }
    });
    ...
    jCheckBoxMinMainMemory.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        jCheckBoxMinPhysicalMemoryEvent(e);
      }
    });
    jCheckBoxSpecFloat2000.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    jCheckBoxMaxAvailableCPUTime.addActionListener(new java.awt.event.
        ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    jCheckBoxMinNumberOfFreeCPUs.addActionListener(new java.awt.event.
        ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    jCheckBoxTimeToTraverseQueue.addActionListener(new java.awt.event.
        ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    jTextFieldMinSpaceOnSE.setText(Float.toString(Utils.MIN_SPACE_ON_SE_DEF_VAL));
    ...
    upMinSpaceOnSE.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.upButtonEvent(jTextFieldMinSpaceOnSE, Utils.FLOAT,
            Float.toString(Utils.MIN_SPACE_ON_SE_DEF_VAL),
            Utils.MIN_SPACE_ON_SE_MIN_VAL, Utils.MIN_SPACE_ON_SE_MAX_VAL);
      }
    });
    jCheckBoxMinSpaceOnSE.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    downMinSpaceOnSE.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.downButtonEvent(jTextFieldMinSpaceOnSE, Utils.FLOAT,
            Float.toString(Utils.MIN_SPACE_ON_SE_DEF_VAL),
            Utils.MIN_SPACE_ON_SE_MIN_VAL, Utils.MIN_SPACE_ON_SE_MAX_VAL);
      }
    });
    ...
    jPanelRemoteMachineType.setBorder(new TitledBorder(new EtchedBorder(),
        " Remote Machine Type ", 0, 0,
        null, GraphicUtils.TITLED_ETCHED_BORDER_COLOR));

    jPanelRemoteMachineType.add(jLabelArchitecture,
        GraphicUtils.setGridBagConstraints(
        gbc, 0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jPanelRemoteMachineType.add(jTextFieldArchitecture,
        GraphicUtils.setGridBagConstraints(
        gbc, 1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jPanelRemoteMachineType.add(jLabelOSType,
        GraphicUtils.setGridBagConstraints(
        gbc, 0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jPanelRemoteMachineType.add(jTextFieldOSType,
        GraphicUtils.setGridBagConstraints(
        gbc, 1, 1, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jPanelRemoteMachineType.add(jLabelOSVersion,
        GraphicUtils.setGridBagConstraints(
        gbc, 0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jPanelRemoteMachineType.add(jTextFieldOSVersion,
        GraphicUtils.setGridBagConstraints(
        gbc, 1, 2, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, null, 0, 0));
    ...
    jPanelReqConnectivity.add(jCheckBoxInbound,
        GraphicUtils.setGridBagConstraints(
        gbc, 0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jPanelReqConnectivity.add(jCheckBoxOutbound,
        GraphicUtils.setGridBagConstraints(
    ...
    jPanelBenchmark.add(jCheckBoxSpecInt2000,
        GraphicUtils.setGridBagConstraints(
        gbc, 0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jTextFieldSpecInt2000.setPreferredSize(GraphicUtils.
        NUMERIC_TEXT_FIELD_DIMENSION);
    jPanelBenchmark.add(jTextFieldSpecInt2000,
        GraphicUtils.setGridBagConstraints(
    ...
    jPanelBenchmark.add(jCheckBoxSpecFloat2000,
        GraphicUtils.setGridBagConstraints(
        gbc, 0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jTextFieldSpecFloat2000.setPreferredSize(GraphicUtils.
        NUMERIC_TEXT_FIELD_DIMENSION);
    jPanelBenchmark.add(jTextFieldSpecFloat2000,
        GraphicUtils.setGridBagConstraints(
        gbc, 1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jPanelBenchmark.add(jPanelArrowSpecFloat,
        GraphicUtils.setGridBagConstraints(
    ...
    jPanelReqQueueManagement.setBorder(new TitledBorder(new EtchedBorder(),
        " Remote Site Job Manager ", 0, 0,
        null, GraphicUtils.TITLED_ETCHED_BORDER_COLOR));

    jPanelReqQueueManagement.add(jLabelLRMSType,
        GraphicUtils.setGridBagConstraints(
        gbc, 0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jPanelReqQueueManagement.add(jTextFieldLRMSType,
        GraphicUtils.setGridBagConstraints(
        gbc, 1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jPanelReqQueueManagement.add(jLabelLRMSVersion,
        GraphicUtils.setGridBagConstraints(
        gbc, 0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jPanelReqQueueManagement.add(jTextFieldLRMSVersion,
        GraphicUtils.setGridBagConstraints(
        gbc, 1, 1, 1, 1, 1.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.HORIZONTAL, null, 0, 0));
    ...
    jPanelReqMiscellaneous.add(jCheckBoxMinNumberOfFreeCPUs,
        GraphicUtils.setGridBagConstraints(
        gbc, 0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jTextFieldMinNumberOfFreeCPUs.setPreferredSize(GraphicUtils.
        NUMERIC_TEXT_FIELD_DIMENSION);
    jPanelReqMiscellaneous.add(jTextFieldMinNumberOfFreeCPUs,
        GraphicUtils.setGridBagConstraints(
        gbc, 1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jPanelReqMiscellaneous.add(jPanelArrowFreeCPU,
        GraphicUtils.setGridBagConstraints(
    ...
    jPanelReqMiscellaneous.add(jCheckBoxMinMainMemory,
        GraphicUtils.setGridBagConstraints(
        gbc, 4, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jTextFieldMinMainMemory.setPreferredSize(GraphicUtils.
        NUMERIC_TEXT_FIELD_DIMENSION);
    jPanelReqMiscellaneous.add(jTextFieldMinMainMemory,
        GraphicUtils.setGridBagConstraints(
        gbc, 5, 0, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jPanelReqMiscellaneous.add(jPanelArrowMainMemory,
        GraphicUtils.setGridBagConstraints(
        gbc, 6, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.BOTH, null, 0, 0));
    ...
    jPanelReqMiscellaneous.add(jCheckBoxMaxAvailableCPUTime,
        GraphicUtils.setGridBagConstraints(
        gbc, 0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jTextFieldMaxAvailableCPUTime.setPreferredSize(GraphicUtils.
        NUMERIC_TEXT_FIELD_DIMENSION);
    jPanelReqMiscellaneous.add(jTextFieldMaxAvailableCPUTime,
        GraphicUtils.setGridBagConstraints(
        gbc, 1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jPanelReqMiscellaneous.add(jPanelArrowCPUTimet,
        GraphicUtils.setGridBagConstraints(
    ...
    jPanelReqMiscellaneous.add(jCheckBoxTimeToTraverseQueue,
        GraphicUtils.setGridBagConstraints(
        gbc, 4, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jTextFieldTimeToTraverseQueue.setPreferredSize(GraphicUtils.
        NUMERIC_TEXT_FIELD_DIMENSION);
    jPanelReqMiscellaneous.add(jTextFieldTimeToTraverseQueue,
        GraphicUtils.setGridBagConstraints(
        gbc, 5, 1, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jPanelReqMiscellaneous.add(jPanelArrowTraverseQueue,
        GraphicUtils.setGridBagConstraints(
        gbc, 6, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.BOTH, null, 0, 0));
    ...
    jPanelApplicationSoftware.add(jLabelRuntimeEnvironment,
        GraphicUtils.setGridBagConstraints(
        gbc, 0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jPanelApplicationSoftware.add(jTextFieldRuntimeEnvironment,
        GraphicUtils.setGridBagConstraints(
        gbc, 1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, null, 0, 0));
    ...
    jPanelStorageRequirements.add(jCheckBoxMinSpaceOnSE,
        GraphicUtils.setGridBagConstraints(
        gbc, 0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jTextFieldMinSpaceOnSE.setPreferredSize(GraphicUtils.
        NUMERIC_TEXT_FIELD_DIMENSION);
    jPanelStorageRequirements.add(jTextFieldMinSpaceOnSE,
        GraphicUtils.setGridBagConstraints(
        gbc, 1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jPanelStorageRequirements.add(jPanelArrowMinSpaceOnSE,
        GraphicUtils.setGridBagConstraints(
        gbc, 2, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.BOTH, null, 0, 0));
    ...
    jPanelSimple.add(jPanelRemoteMachineType,
        GraphicUtils.setGridBagConstraints(
        gbc, 0, 0, 3, 1, 1.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.BOTH, null, 0, 0));
    ...
    jPanelSimple.add(jPanelBenchmark, GraphicUtils.setGridBagConstraints(
        gbc, 0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.BOTH, null, 0, 0));

    jPanelSimple.add(jPanelReqQueueManagement,
        GraphicUtils.setGridBagConstraints(
        gbc, 1, 1, 5, 1, 1.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.BOTH, null, 0, 0));

    jPanelSimple.add(jPanelReqMiscellaneous, GraphicUtils.setGridBagConstraints(
        gbc, 0, 2, 5, 1, 1.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.BOTH, null, 0, 0));

    jPanelSimple.add(jPanelApplicationSoftware,
        GraphicUtils.setGridBagConstraints(
        gbc, 0, 3, 5, 1, 1.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.BOTH, null, 0, 0));

    jPanelSimple.add(jPanelStorageRequirements,
        GraphicUtils.setGridBagConstraints(
        gbc, 0, 4, 2, 1, 0.0, 1.0, GridBagConstraints.FIRST_LINE_START,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    // this
    this.setLayout(gbl);
    GraphicUtils.setDefaultGridBagConstraints(gbc);
    this.add(jPanelNorth, GraphicUtils.setGridBagConstraints(
        gbc, 0, 0, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.BOTH, new Insets(1, 1, 1, 1), 0, 0));

    this.add(jPanelSimple, GraphicUtils.setGridBagConstraints(
        gbc, 0, 1, 1, 1, 0.0, 1.0, GridBagConstraints.CENTER,
        GridBagConstraints.BOTH, null, 0, 0));

    this.add(requirementsAdvancedPanel, GraphicUtils.setGridBagConstraints(
        gbc, 0, 2, 1, 1, 0.0, 1.0, GridBagConstraints.CENTER,
        GridBagConstraints.BOTH, null, 0, 0));
  ...
  public void setRequirementsTree(String expr) {
    if (!expr.trim().toUpperCase().equals(GUIGlobalVars.
        getGUIConfVarRequirements())) {
  ...
  String jButtonRequirementsViewEvent(boolean showWarningMsg,
    ...
    if (!opSysText.equals("")) {
      if ((exprAttributesName.getValue("OSTypeAndVersion") != null)
          && !(exprAttributesName.getValue("OSTypeAndVersion").trim().equals(""))) {
        result += " && other." + exprAttributesName.getValue("OSTypeAndVersion")
            + " == \"" + opSysText
            + oSVersionText + "\"";
      } else {
      ...
      if (!oSVersionText.equals("")) {
        JOptionPane.showOptionDialog(RequirementsPanel.this,
            "You cannot specify OSVersion without OSType",
            Utils.ERROR_MSG_TXT,
    ...
    String runTimeEnvironmentText = jTextFieldRuntimeEnvironment.getText().trim();
    ...
    if (jCheckBoxMinSpaceOnSE.isSelected() == true) {
      ...
      result +=
          " && anyMatch(other.storage.CloseSEs, target.GlueSAStateAvailableSpace > "
          + minSpaceOnSE + ")";
    }
  ...
  void enableAttributeFromConfFile() {
    ...
    String minNumberOfFreeCPUs = exprAttributesName.getValue(
        "minNumberOfFreeCPUs");
    if ((minNumberOfFreeCPUs == null) || (minNumberOfFreeCPUs.trim().equals(""))) {
      jCheckBoxMinNumberOfFreeCPUs.setEnabled(false);
    }

    String maxAvailableCPUTime = exprAttributesName.getValue(
        "maxAvailableCPUTime");
    if ((maxAvailableCPUTime == null) || (maxAvailableCPUTime.trim().equals(""))) {
      jCheckBoxMaxAvailableCPUTime.setEnabled(false);
      jLabelSec1.setEnabled(false);
    }

    String timeToTraverseQueue = exprAttributesName.getValue(
        "timeToTraverseQueue");
    if ((timeToTraverseQueue == null) || (timeToTraverseQueue.trim().equals(""))) {
      jCheckBoxTimeToTraverseQueue.setEnabled(false);
      jLabelSec2.setEnabled(false);
    }

    String runtimeEnvironment = exprAttributesName.getValue(
        "runtimeEnvironment");
