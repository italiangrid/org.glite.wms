...
public class GUIConfigSAXParser extends DefaultHandler {
  ...
  public Vector getAttribute() {
    ...
    for(int i = 0; i < attributeNameVector.size(); i++) {
      ...
      if(isMultivaluedText.equals("true")) isMultivalued = true;
  ...
  public Vector getFunction() {
    ...
    for(int i = 0; i < functionNameVector.size(); i++) {
      ...
      function.add(new Function(functionNameVector.get(i).toString(),
                 Integer.parseInt(functionTypeVector.get(i).toString(), 10),
...
class JDLConfigSAXHandler extends DefaultHandler {
  ...
  public void startElement (String uri, String name, String qName, Attributes atts)  {
    if(name.equals("jdleconfig")) {
      ...
      for(int i = 0; i < atts.getLength(); i++) {
        ...
        exprAttributesName.putValue(attributeName, atts.getValue(attributeName).trim());
      }
    }
  }
  ...
  public void endElement (String uri, String name, String qName) {
    ...
    if(name.equals("jdleconfig")) {
      ...
      //System.out.println("attribute");
      if(isMultivalued) attributeMultiVector.add("true");
      else attributeMultiVector.add("false");
      isMultivalued = false;
      isAttribute = false;
