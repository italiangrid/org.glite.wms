 ...
 * This class provides constant values and utility methods.
 *
 * @ingroup gui
 ...
 */
public class Utils {
  //static Logger logger = Logger.getLogger(CredentialInformation.class.getName());
  ...
  static final String COPYRIGHT =
      "Copyright (C) 2001 The European DataGrid Project\nIST programme,"
      + " all rights reserved\nDeveloped by Datamat S.p.A.";

  // Tabbed pane panel names. Do not change order, add at the end!!
  static final String[] GUI_PANEL_NAMES = {
      "Type", "Files", "Environment", "Input Data",
      "Output Data", "Requirements", "Rank", "Unknown", "Tags"
  };
  ...
  static final String[] guiAttributesArray = {
      Jdl.TYPE, Jdl.JOBTYPE, Jdl.DEFAULT_RANK, Jdl.CEID,
      Jdl.STR_USER_PROXY, // API attributes 'automatically' inserted in a jdl file.
      ...
      Jdl.STDOUTPUT,
      Jdl.STDERROR, Jdl.INPUTSB, Jdl.OUTPUTSB,

      Jdl.ENVIRONMENT, Jdl.MYPROXY, /*Jdl.USER_CONTACT,*/ Jdl.HLR_LOCATION,
      Jdl.RETRYCOUNT,

      Jdl.INPUTDATA, /*Jdl.REPLICA_CATALOG,*/ Jdl.DATA_ACCESS,

      Jdl.OUTPUTDATA, Jdl.OUTPUT_SE,

      Jdl.REQUIREMENTS, Jdl.RANK, Jdl.FUZZY_RANK,
  ...
  static final String[] jobDefinition2AttributeArray = {
      Jdl.ENVIRONMENT, Jdl.MYPROXY, /*Jdl.USER_CONTACT,*/ Jdl.HLR_LOCATION,
      Jdl.RETRYCOUNT
  };

  static final String[] jobInputDataAttributeArray = {
      Jdl.INPUTDATA, /*Jdl.REPLICA_CATALOG,*/ Jdl.DATA_ACCESS
  };

  static final String[] requirementsAttributeArray = {
      Jdl.REQUIREMENTS
  };

  static final String[] rankAttributeArray = {
      Jdl.RANK, Jdl.FUZZY_RANK
  };

  static final String[] jobTypeAttributeArray = {
      Jdl.TYPE, Jdl.JOBTYPE, Jdl.NODENUMB, Jdl.CHKPT_STEPS,
      Jdl.CHKPT_CURRENTSTEP,
      Jdl.SHPORT
  };

  static final String[] jobOutputDataAttributeArray = {
      Jdl.OUTPUTDATA, Jdl.OUTPUT_SE
  };

  static final String[] tagsAttributeArray = {
      Jdl.USER_TAGS
  };
  ...
  static final String[] TYPE_NAMES = {
      "Integer", "Float", "Boolean", "String", "Expr", "AbsTime", "RelTime",
      "Memory", "Seconds"
  };
  ...
  static final String[][] jdleSchemaNameConfFile = { {"GLUE",
      GLUE_CONF_FILE_NAME}
  ...
  static final String WRONG_COMPONENT_ARGUMENT_TYPE =
      "Wrong component argument type";
  ...
  static final int SHADOWPORT_MAX_VAL = Integer.MAX_VALUE; //!!! Check this value.
  ...
  static final String GUI_CONF_VAR_MAX_MONITORED_JOB_NUMBER =
      "MaxMonitoredJobNumber";

  static final String GUI_CONF_VAR_NS_LOGGER_LEVEL = "NSLoggerLevel";

  // Names of attributes used in OutputData attribute (OutputData is of Ad type).
  ...
  /**
   * Substitutes single occurence of backslash with a double one.
   ...
   * format: e.g. if '\' is followed by 'n' you have \n -> "new line")
   */
    ...
    switch (type) {
      case INTEGER:
        ...
        if (value.equals("")) {
          ...
          try {
            int parsedValue = intValue.parseInt(value, 10);
      ...
      case FLOAT:
        ...
        if (value.equals("")) {
          ...
          try {
            float parsedValue = floatValue.parseFloat(value);
            if ((parsedValue < minValue) || (parsedValue > maxValue)) {
              result = false;
            }
          } catch (NumberFormatException e) {
  ...
  static void upButtonEvent(JComponent jComponent, int type,
      String defaultValue,
      float minValue, double maxValue) {
    JTextField jTextField = null;
    if (jComponent instanceof JTextField) {
      jTextField = (JTextField) jComponent;
    } else {
    ...
    switch (type) {
      case Utils.INTEGER:
        if (result) {
          ...
          Integer intValue = null;
          try {
            int newValue = intValue.parseInt(value, 10);
      ...
      case Utils.FLOAT:
        if (result) {
          ...
          Float floatValue = null;
          try {
            float newValue = floatValue.parseFloat(value);
  ...
  public static int getOperatingSystem() {
    ...
    if (operatingSystem.equals("Linux")
        || operatingSystem.equals("Unix") // Maybe "Unix" is not necessary.
  ...
  /**
   * Converts a String in the format: "[0123456789].[0123456789] s" into a
    ...
    while (newIndex != -1) {
      ...
      if (varValue != null) {
        ...
        path = path.substring(0,
            newIndex) + varValue + path.substring(newIndex + 1 + varNameLength);
