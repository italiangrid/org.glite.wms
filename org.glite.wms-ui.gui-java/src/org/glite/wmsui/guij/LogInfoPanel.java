...
public class LogInfoPanel extends JPanel {
  ...
  static int[] primaryAttNames = {
      org.glite.wmsui.apij.Event.CLASSAD,
      org.glite.wmsui.apij.Event.DESCR,
      org.glite.wmsui.apij.Event.JDL,
      org.glite.wmsui.apij.Event.JOB,
      org.glite.wmsui.apij.Event.JOBID};
  ...
  static final int[] eventAttributeIndex = {
      ...
      org.glite.wmsui.apij.Event.EXIT_CODE,

      org.glite.wmsui.apij.Event.FROM,
      ...
      org.glite.wmsui.apij.Event.HOST,
      org.glite.wmsui.apij.Event.JDL,
      org.glite.wmsui.apij.Event.JOB,

      org.glite.wmsui.apij.Event.JOBID,
      org.glite.wmsui.apij.Event.LEVEL,
      org.glite.wmsui.apij.Event.LOCAL_JOBID,
      org.glite.wmsui.apij.Event.NAME,

      org.glite.wmsui.apij.Event.NODE,
      org.glite.wmsui.apij.Event.NS,
      org.glite.wmsui.apij.Event.NSUBJOBS,
      org.glite.wmsui.apij.Event.PARENT,
      org.glite.wmsui.apij.Event.PRIORITY,

      org.glite.wmsui.apij.Event.QUEUE,
      org.glite.wmsui.apij.Event.REASON,
      org.glite.wmsui.apij.Event.RESULT,
      org.glite.wmsui.apij.Event.RETVAL,

      org.glite.wmsui.apij.Event.SEED,
      org.glite.wmsui.apij.Event.SEQCODE,
      ...
      org.glite.wmsui.apij.Event.SVC_HOST,
      org.glite.wmsui.apij.Event.SVC_NAME,

      org.glite.wmsui.apij.Event.SVC_PORT,
      org.glite.wmsui.apij.Event.TAG,
      org.glite.wmsui.apij.Event.TIMESTAMP,
      org.glite.wmsui.apij.Event.USER,

      org.glite.wmsui.apij.Event.VALUE};

  static final String[] eventAttributeDescr = {
      "Checkpoint State", "Current Job Description", "Destination Host",
      "Destination Instance",
      "Destination CE Id", "Dest Internal Job Id", "Job Transfer Destination",
      "Process Exit Code",
      "Accepted/Refused From", "Sending Component Host",
      "Sending Component Instance", "Helper Name",
      "Helper Call Params", "Source Host Name", " User Job Description",
      "Receiver Job Description",
      "Job Identifier", "Logging Level", "Local Job Identifier",
      "User Tag Name",
      "Execution Worker Node", "Network Server", "Number of Subjobs",
      "Parent Job Identifier", "Message Priority",
      "Destination Queue", "Status Reason", "Transfer Result/Result Code",
      "Helper Call Return",
      "Subjob Id Generation Seed", "Sequence Code", "Event Source",
      "Source Instance",
      "Source Role", "Status Code", "Listener Host", "Listener Name",
      "Listener Port", "Chkpt Tag/Resubmission Tag", "Event Generation Time",
      "User",
      "UserTag Value"};
  ...
  private void jbInit() throws Exception {
    ...
    jButtonChkptState.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        jButtonShowJDLAttriuteEvent(org.glite.wmsui.apij.Event.
            CLASSAD, e);
      }
    });
    ...
    jScrollPaneAttribute.setCorner(JScrollPane.UPPER_LEFT_CORNER,
    ...
    jPanelEventLogInfo.setBorder(new TitledBorder(new EtchedBorder(),
        " Selected Event Logging Info ", 0, 0,
    ...
    this.add(jPanelLastUpdate, GraphicUtils.setGridBagConstraints(
        gbc, 0, 0, 1, 1, 1.0, 0.0, GridBagConstraints.FIRST_LINE_START,
        GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));

    this.add(jPanelJobId, GraphicUtils.setGridBagConstraints(
        gbc, 0, 1, 1, 1, 1.0, 0.0, GridBagConstraints.FIRST_LINE_START,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    this.add(jPanelJobEvents, GraphicUtils.setGridBagConstraints(
        gbc, 0, 2, 1, 1, 1.0, 0.5, GridBagConstraints.FIRST_LINE_START,
        GridBagConstraints.BOTH, null, 0, 0));

    this.add(jPanelEventLogInfo, GraphicUtils.setGridBagConstraints(
        gbc, 0, 3, 1, 1, 1.0, 0.5, GridBagConstraints.FIRST_LINE_START,
        GridBagConstraints.BOTH, null, 0, 0));

    this.add(jPanelButtonJDL, GraphicUtils.setGridBagConstraints(
        gbc, 0, 4, 1, 1, 1.0, 0.0, GridBagConstraints.FIRST_LINE_START,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    this.add(jPanelButton, GraphicUtils.setGridBagConstraints(
        gbc, 0, 5, 1, 1, 1.0, 0.0, GridBagConstraints.FIRST_LINE_START,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    setTableEventAttributes((org.glite.wmsui.apij.Event)
        eventVector.get(0));
  ...
  void setTableEventAttributes(int selectedRow) {
    org.glite.wmsui.apij.Event event = (org.glite.wmsui.apij.Event) eventVector.get(selectedRow);
  ...
  void setTableEventAttributes(org.glite.wmsui.apij.Event event) {
    ...
    for (int i = 0;
        i < org.glite.wmsui.apij.Event.attrNames.length; i++) {
      ...
      if (value != null) {
        ...
        if (attributeDescr != null) {
          ...
          rowToAddHeader.add(org.glite.wmsui.apij.Event.attrNames[
              i]);
        }
    ...
    String valueTxt = "";
    valueTxt = event.getValString(org.glite.wmsui.apij.Event.
        CLASSAD);
  ...
  void addTableEvents(Vector eventVector) {
    ...
    for (int i = 0; i < eventVector.size(); i++) {
      ...
      if (i == 0) {
        ...
        jTextFieldJobId.setText(event.getValString(org.glite.wmsui.apij.Event.JOBID));
      }
      rowToAddVector.add(event.name().toString());
      rowToAddVector.add(event.getValString(org.glite.wmsui.apij.
          Event.SOURCE));
      timeStamp = event.getValString(org.glite.wmsui.apij.Event.
          TIMESTAMP);
      if (timeStamp != null) {
  ...
  void jButtonShowJDLAttriuteEvent(int attribute, ActionEvent e) {
    ...
    if ((text != null) && !text.equals("")) {
      ...
      try {
        ...
        JOptionPane.showOptionDialog(LogInfoPanel.this,
