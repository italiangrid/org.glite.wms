...
public class RequirementsAdvancedPanel extends JPanel {
  ...
  private void jbInit() throws Exception {
    ...
    String relation =
        "<html><font color=\"#0000AA\">" + " Relation " + "</font>";
    String operator =
        "<html><font color=\"#0000AA\">" + " Operator " + "</font>";
    ...
    jTextFieldDay.setText(Integer.toString(calendar.get(Calendar.DAY_OF_MONTH)));
    ...
    jComboBoxAttributesFirstOperand.addActionListener(new java.awt.event.
        ActionListener() {
      public void actionPerformed(ActionEvent e) {
        jComboBoxAttributesFirstOperandEvent(e);
      }
    });
    jTextFieldValueSecondOperand.addFocusListener(new java.awt.event.
        FocusAdapter() {
    ...
    jRadioButtonAttributeFirstOperand.addActionListener(new java.awt.event.
        ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    jRadioButtonFunctionFirstOperand.addActionListener(new java.awt.event.
        ActionListener() {
      public void actionPerformed(ActionEvent e) {
        jRadioButtonChangeEvent("Function", FIRSTOPERAND, e);
      }
    });
    jComboBoxFunctionsFirstOperand.addActionListener(new java.awt.event.
        ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    jComboBoxFirstOperandParam1.addActionListener(new java.awt.event.
        ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    jRadioButtonValueSecondOperand.addActionListener(new java.awt.event.
        ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    jTextFieldYear.addFocusListener(new java.awt.event.FocusAdapter() {
      public void focusLost(FocusEvent e) {
        GraphicUtils.jTextFieldFocusLost(jTextFieldYear, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.YEAR)), 1970, 9999);
      }
    });
    downMonth.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.downButtonEvent(jTextFieldMonth, Utils.INTEGER,
    ...
    upMonth.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.upButtonEvent(jTextFieldMonth, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.MONTH) + 1), 1, 12);
      }
    });
    ...
    jTextFieldDay.addFocusListener(new java.awt.event.FocusAdapter() {
      public void focusLost(FocusEvent e) {
        GraphicUtils.jTextFieldFocusLost(jTextFieldDay, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.DAY_OF_MONTH)), 1, 31);
      }
    });
    downDay.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.downButtonEvent(jTextFieldDay, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.DAY_OF_MONTH)), 1, 31);
      }
    });
    upDay.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.upButtonEvent(jTextFieldDay, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.DAY_OF_MONTH)), 1, 31);
      }
    });
    ...
    downHours.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.downButtonEvent(jTextFieldHours, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.HOUR)), 0, 23);
      }
    });
    upHours.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.upButtonEvent(jTextFieldHours, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.HOUR)), 0, 23);
      }
    });
    ...
    downMinutes.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.downButtonEvent(jTextFieldMinutes, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.MINUTE)), 0, 59);
      }
    });
    upMinutes.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.upButtonEvent(jTextFieldMinutes, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.MINUTE)), 0, 59);
      }
    });
    ...
    downSeconds.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.downButtonEvent(jTextFieldSeconds, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.SECOND)), 0, 59);
      }
    });
    upSeconds.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.upButtonEvent(jTextFieldSeconds, Utils.INTEGER,
            Integer.toString(calendar.get(Calendar.SECOND)), 0, 59);
      }
    });
    ...
    jPanelFirstOperand.setBorder(new TitledBorder(new EtchedBorder(),
        " First Operand ", 0, 0,
        null, GraphicUtils.TITLED_ETCHED_BORDER_COLOR));

    jPanelFirstOperand.add(jRadioButtonAttributeFirstOperand,
        GraphicUtils.setGridBagConstraints(
        gbc, 0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, null, 0, 0));

    jPanelFirstOperand.add(jComboBoxAttributesFirstOperand,
        GraphicUtils.setGridBagConstraints(
    ...
    jPanelFirstOperand.add(jRadioButtonFunctionFirstOperand,
        GraphicUtils.setGridBagConstraints(
        gbc, 0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, null, 0, 0));

    jPanelFirstOperand.add(jComboBoxFunctionsFirstOperand,
        GraphicUtils.setGridBagConstraints(
    ...
    jPanelFirstOperand.add(jPanelFunctionParamsFirstOperand,
        GraphicUtils.setGridBagConstraints(
    ...
    GraphicUtils.setDefaultGridBagConstraints(gbc);
    jPanelSecondOperand.setBorder(new TitledBorder(new EtchedBorder(),
        " Second Operand ", 0, 0,
        null, GraphicUtils.TITLED_ETCHED_BORDER_COLOR));

    jPanelSecondOperand.add(jRadioButtonAttributeSecondOperand,
        GraphicUtils.setGridBagConstraints(
        gbc, 0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, null, 0, 0));

    jPanelSecondOperand.add(jComboBoxAttributesSecondOperand,
        GraphicUtils.setGridBagConstraints(
        gbc, 1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    jPanelSecondOperand.add(jRadioButtonValueSecondOperand,
        GraphicUtils.setGridBagConstraints(
        gbc, 2, 0, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, null, 0, 0));

    jPanelSecondOperand.add(jTextFieldValueSecondOperand,
        GraphicUtils.setGridBagConstraints(
        gbc, 3, 0, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, null, 0, 4));

    jPanelSecondOperand.add(jRadioButtonFunctionSecondOperand,
        GraphicUtils.setGridBagConstraints(
        gbc, 0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, null, 0, 0));

    jPanelSecondOperand.add(jComboBoxFunctionsSecondOperand,
        GraphicUtils.setGridBagConstraints(
        gbc, 1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, null, 0, 0));
    ...
    jPanelSecondOperand.add(jPanelFunctionParamsSecondOperand,
        GraphicUtils.setGridBagConstraints(
        gbc, 0, 2, 4, 1, 0.5, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, null, 0, 0));
    ...
    this.setLayout(gbl);
    GraphicUtils.setDefaultGridBagConstraints(gbc);
    this.add(jPanelFirstOperand, GraphicUtils.setGridBagConstraints(
        gbc, 0, 0, 1, 1, 1.0, 0.0, GridBagConstraints.FIRST_LINE_START,
        GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));

    this.add(jPanelRelation, GraphicUtils.setGridBagConstraints(
        gbc, 0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.FIRST_LINE_START,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    this.add(jPanelSecondOperand, GraphicUtils.setGridBagConstraints(
        gbc, 0, 2, 1, 1, 1.0, 0.0, GridBagConstraints.FIRST_LINE_START,
        GridBagConstraints.HORIZONTAL, null, 0, 0));

    this.add(jPanelClassAdTree, GraphicUtils.setGridBagConstraints(
        gbc, 0, 3, 1, 1, 0.0, 1.0, GridBagConstraints.FIRST_LINE_START,
        GridBagConstraints.BOTH, null, 0, 0));
  ...
  boolean isParameterTypeMatch(int paramNumber, String param, int operand) {
    ...
    switch (operand) {
      ...
      case SECONDOPERAND:
        selectedFunctionItem = jComboBoxFunctionsSecondOperand.getSelectedItem().
            toString();
        break;
    }
  ...
  void jButtonAddEvent(ActionEvent e) {
    ...
    if (jRadioButtonAttributeFirstOperand.isSelected()) {
      ...
      Vector functionParamsVector = getFunctionParameterTypes(
          selectedFunctionTextFirstOperand);
      ...
      if (jComboBoxFirstOperandParam1.isVisible() &&
        ...
        if (selectedFunctionFirstParameterType == Utils.LIST) {
          nodeTextFirstOperand = Utils.swapFunctionParameters(
              nodeTextFirstOperand);
        ...
        if (jComboBoxFirstOperandParam1.isVisible()) {
          ...
          if (param1.equals("")) {
            ...
            for (int i = 0; i < jComboBoxFirstOperandParam1.getModel().getSize();
                i++) {
              jComboBoxFirstOperandParam1Vector.add((String)
                  jComboBoxFirstOperandParam1.getModel().getElementAt(i));
            }
        ...
        if (jComboBoxFirstOperandParam2.isVisible()) {
          ...
          if (param2.equals("")) {
            ...
            for (int i = 0; i < jComboBoxFirstOperandParam2.getModel().getSize();
                i++) {
              jComboBoxFirstOperandParam2Vector.add((String)
                  jComboBoxFirstOperandParam2.getModel().getElementAt(i));
            }
        ...
        if (jComboBoxFirstOperandParam3.isVisible()) {
          ...
          if (param3.equals("")) {
            ...
            for (int i = 0; i < jComboBoxFirstOperandParam3.getModel().getSize();
                i++) {
              jComboBoxFirstOperandParam3Vector.add((String)
                  jComboBoxFirstOperandParam3.getModel().getElementAt(i));
            }
    ...
    if (jRadioButtonAttributeFirstOperand.isSelected() &&
      ...
      if (firstOperandType == Utils.ABS_TIME) {
        ...
        StringBuffer stringBuffer = new StringBuffer(simpleDateFormat.format(
            date));
        ...
        if (value.equals("")) {
          ...
          if (firstOperandType != Utils.STRING) {
            if (((firstOperandType == Utils.INTEGER)
                ...
                || (firstOperandType == Utils.MEMORY)
                || (firstOperandType == Utils.SECONDS))
      ...
      String selectedFunctionTextSecondOperand = selectedFunctionSecondOperand.
          toString();
      Vector functionParamsVector = getFunctionParameterTypes(
          selectedFunctionTextSecondOperand);
      ...
      if (jComboBoxSecondOperandParam1.isVisible()) {
        ...
        if (param1.equals("")) {
          ...
          for (int i = 0; i < jComboBoxSecondOperandParam1.getModel().getSize();
              i++) {
            jComboBoxSecondOperandParam1Vector.add((String)
                jComboBoxSecondOperandParam1.getModel().getElementAt(i));
          }
      ...
      if (jComboBoxSecondOperandParam2.isVisible()) {
        String param2 = jComboBoxSecondOperandParam2.getSelectedItem().toString().
            trim();
        if (param2.equals("")) {
          showJOptionPane(
          ...
          for (int i = 0; i < jComboBoxSecondOperandParam2.getModel().getSize();
              i++) {
            jComboBoxSecondOperandParam2Vector.add((String)
                jComboBoxSecondOperandParam2.getModel().getElementAt(i));
          }
      ...
      if (jComboBoxSecondOperandParam3.isVisible()) {
        ...
        if (param3.equals("")) {
          ...
          for (int i = 0; i < jComboBoxSecondOperandParam3.getModel().getSize();
              i++) {
            jComboBoxSecondOperandParam3Vector.add((String)
                jComboBoxSecondOperandParam3.getModel().getElementAt(i));
          }
    ...
    if ((selectedNodeText.equals("AND")) || (selectedNodeText.equals("AND NOT"))
        ||(selectedNodeText.equals("OR")) || (selectedNodeText.equals("OR NOT"))) {
      return;
    }
  ...
  private void jRadioButtonChangeEvent(String choice, int operand,
      ActionEvent e) {
      ...
      for (int j = 0; j < confFileFunctionsVector.size(); j++) {
        ...
        if (selectedFunctionItem.equals(functionName)) {
          ...
          for (int i = 0; i < attributesArrayList.size(); i++) {
            if (parameterCount >= 1) {
              if (getAttributeType(i) ==
                  Integer.parseInt(selectedFunctionParamTypes.get(0).toString(),
                  10)) {
            ...
            if (parameterCount >= 2) {
              if (getAttributeType(i) ==
                  Integer.parseInt(selectedFunctionParamTypes.get(1).toString(),
                  10)) {
                if (!getAttributeIsMultivalued(i)) {
            ...
            if (parameterCount == 3) {
              if (getAttributeType(i) ==
                  Integer.parseInt(selectedFunctionParamTypes.get(2).toString(),
                  10)) {
                if (!getAttributeIsMultivalued(i)) {
  ...
  private void attributesFirstOperandSetJCombo() {
    if (jComboBoxAttributesFirstOperand.getItemCount() != 0) {
      String selectedAttributeItem =
          jComboBoxAttributesFirstOperand.getSelectedItem().toString(); // Attribute name.
      int selectedAttributeType =
          getAttributeType(selectedAttributeItem); // Attribute type.
  ...
  private void functionsFirstOperandSetJCombo() {
    if (jComboBoxFunctionsFirstOperand.getItemCount() != 0) {
      String selectedFunctionItem =
          jComboBoxFunctionsFirstOperand.getSelectedItem().toString(); // Function name.
      int selectedFunctionType =
          getFunctionType(selectedFunctionItem); // Function type.
      Vector selectedFunctionParamTypes =
          getFunctionParameterTypes(selectedFunctionItem); // Function parameters.
  ...
  String jButtonRequirementsAdvancedPanelViewEvent(boolean showWarningMsg,
    ...
    if (!errorMsg.equals("") && showErrorMsg) {
      GraphicUtils.showOptionDialogMsg(RequirementsAdvancedPanel.this, errorMsg,
          Utils.ERROR_MSG_TXT,
      ...
      if (!warningMsg.equals("") && showWarningMsg) {
        GraphicUtils.showOptionDialogMsg(RequirementsAdvancedPanel.this, warningMsg,
