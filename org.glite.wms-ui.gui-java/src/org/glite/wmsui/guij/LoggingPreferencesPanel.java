...
public class LoggingPreferencesPanel extends JPanel {
  ...
  BasicArrowButton upLoggingTimeout = new BasicArrowButton(BasicArrowButton.
      NORTH);
  BasicArrowButton downLoggingTimeout = new BasicArrowButton(BasicArrowButton.
      SOUTH);
  JTextField jTextFieldLoggingSyncTimeout = new JTextField();
  BasicArrowButton downLoggingSyncTimeout = new BasicArrowButton(
      BasicArrowButton.SOUTH);
  BasicArrowButton upLoggingSyncTimeout = new BasicArrowButton(BasicArrowButton.
      NORTH);
  ...
  private void jbInit() throws Exception {
    ...
    jTextFieldLoggingTimeout.setText(Integer.toString(Utils.
        LOGGING_TIMEOUT_DEF_VAL));
    ...
    jTextFieldLoggingTimeout.addFocusListener(new java.awt.event.FocusAdapter() {
    ...
    upLoggingTimeout.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.upButtonEvent(jTextFieldLoggingTimeout, Utils.INTEGER,
            Integer.toString(Utils.LOGGING_TIMEOUT_DEF_VAL),
            Utils.LOGGING_TIMEOUT_MIN_VAL, Utils.LOGGING_TIMEOUT_MAX_VAL);
      }
    });
    ...
    downLoggingTimeout.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        Utils.downButtonEvent(jTextFieldLoggingTimeout, Utils.INTEGER,
            Integer.toString(Utils.LOGGING_TIMEOUT_DEF_VAL),
            Utils.LOGGING_TIMEOUT_MIN_VAL, Utils.LOGGING_TIMEOUT_MAX_VAL);
      }
    });

    jTextFieldLoggingSyncTimeout.addFocusListener(new java.awt.event.
        FocusAdapter() {
      public void focusLost(FocusEvent e) {
        GraphicUtils.jTextFieldFocusLost(jTextFieldLoggingTimeout,
            Utils.INTEGER, Integer.toString(Utils.LOGGING_SYNC_TIMEOUT_DEF_VAL),
    ...
    downLoggingSyncTimeout.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    jTextFieldLoggingSyncTimeout.setText(Integer.toString(Utils.
    ...
    jButtonErrorStorageFile.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    jPanelLogging.setBorder(new TitledBorder(new EtchedBorder(), " LB Logging ",
        0, 0,
    ...
    jCheckBoxLoggingTimeout.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    jCheckBoxLoggingSyncTimeout.addActionListener(new java.awt.event.
        ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    jPanelErrorStorage.setBorder(new TitledBorder(new EtchedBorder(),
        " JDL Editor Parsing Error File Path ", 0, 0,
        null, GraphicUtils.TITLED_ETCHED_BORDER_COLOR));
  ...
  int jButtonApplyEvent(ActionEvent ae) {
    ...
    String title = "<html><font color=\"#602080\">"
        + JobSubmitterPreferences.LOGGING_PANEL_NAME
        + ":" + "</font>";
    ...
    try {
      ...
      if (jCheckBoxLoggingTimeout.isSelected()) {
        int loggingTimeout = Integer.parseInt(jTextFieldLoggingTimeout.getText(),
            10);
        confAd.setAttribute(Utils.GUI_CONF_VAR_LOGGING_TIMEOUT, loggingTimeout);
      ...
      try {
        ...
        if (userConfAd.hasAttribute(Utils.GUI_CONF_VAR_LOGGING_SYNC_TIMEOUT)) {
          ...
          jTextFieldLoggingSyncTimeout.setText(((Integer) userConfAd.
              getIntValue(
              Utils.GUI_CONF_VAR_LOGGING_SYNC_TIMEOUT).get(0)).toString());
        }
    ...
    if (defPrefFile.isFile()) {
      ...
      try {
        ...
        if (defPrefAd.hasAttribute(Utils.GUI_CONF_VAR_LOGGING_SYNC_TIMEOUT)) {
          setLoggingSyncTimeoutEnabled(true);
          jCheckBoxLoggingSyncTimeout.setSelected(true);
          jTextFieldLoggingSyncTimeout.setText(((Integer) defPrefAd.getIntValue(
              Utils.GUI_CONF_VAR_LOGGING_SYNC_TIMEOUT).get(0)).toString());
        }
