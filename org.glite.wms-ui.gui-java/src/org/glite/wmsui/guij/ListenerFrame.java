...
import java.awt.event.* ;  // listener Event manipulation
...
public class ListenerFrame extends JFrame  implements Listener ,  ActionListener{
  ...
  public ListenerFrame() {
    ...
    try {     jbInit();   }
    catch(Exception e) {     if (isDebugging) e.printStackTrace();   }
  }
 ...
 public void run ( Shadow sh){
   ...
   public void stop(){
     ...
     try{
       ...
       if (isDebugging) exc.printStackTrace();
       this.dispose();
     }
   ...
   public void actionPerformed (ActionEvent actionEvent) {
      ...
      if (   ( source == jButtonSend ) || (source == jTextFieldIn)   ){
       ...
       else if  ( source == jButtonClose )  refresh = false ;
   }
        /*
        *  MAIN method
        */
