#ifndef EDG_WORKLOAD_COMMON_UTILITIES_FILELISTITERATOR_H
#define EDG_WORKLOAD_COMMON_UTILITIES_FILELISTITERATOR_H

#ifndef EDG_WORKLOAD_COMMON_UTILITIES_FILECONTAINER_H
...
#endif /* EDG_WORKLOAD_COMMON_UTILITIES_FILELISTITERATOR_H */
