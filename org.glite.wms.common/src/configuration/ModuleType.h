#ifndef EDG_WORKLOAD_COMMON_CONFIGURATION_MODULETYPE_H
#define EDG_WORKLOAD_COMMON_CONFIGURATION_MODULETYPE_H
...
#endif /* EDG_WORKLOAD_COMMON_CONFIGURATION_MODULETYPE_H */
